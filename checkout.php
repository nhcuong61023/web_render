...
<?php
	...
	echo "<tr><td style='background-color: #ccc;'></td><td style='text-align: right;background-color: #ccc;''>Total Price: <b>".$total." VNĐ</b></td></tr>";
	echo "</table>";
	echo "</div>";
